  ...
  return (
    <div className="space-y-8">
      ...
      <div className="animate-pulse space-y-4 opacity-40">
        <div className="h-32 border border-zinc-800 bg-zinc-900/30" />
        <div className="grid gap-4 lg:grid-cols-3">
          <div className="h-28 border border-zinc-800 bg-zinc-900/30 lg:col-span-2" />
          <div className="h-28 border border-zinc-800 bg-zinc-900/30" />
        </div>
      </div>
    </div>
  );
