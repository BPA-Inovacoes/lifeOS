      ...
      <div className="mt-4 flex items-center justify-between gap-3">
        ...
        {onPrestige ? (
          <button
            ...
            onClick={onPrestige}
            className="border border-zinc-700 px-3 py-1.5 font-mono text-[10px] uppercase tracking-wider text-zinc-200 disabled:cursor-not-allowed disabled:text-zinc-600"
          >
