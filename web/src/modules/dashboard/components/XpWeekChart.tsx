  ...
  return (
    <section className="relative border border-zinc-800 bg-zinc-950">
      ...
      <div className="border-b border-zinc-800 px-4 py-4 md:px-6">
        ...
        <h2 className="mt-1 text-lg font-medium text-white">XP — últimos 7 dias</h2>
        <p className="mt-1 text-sm text-zinc-500">
          <span className="font-mono text-emerald-500">{weekTotal} pt</span> esta
            ...
            >
              ...
              >
                <div
                  className={cn(
                    ...
                    day.total === 0 && "bg-zinc-800/80 border-zinc-800"
                  )}
                  style={{ height: h }}
                />
              </div>
              <span
                className={cn(
                  ...
                  day.isToday ? "text-emerald-500" : "text-zinc-600"
                )}
              >
                {day.label}
              </span>
